...
FILESEXTRAPATHS:prepend = "${THISDIR}/patches/atf:"
FILESEXTRAPATHS:prepend:espressobin-v7 := "${THISDIR}/patches-v7/atf:"
...
FILESEXTRAPATHS:prepend = "${THISDIR}/patches/a3700-utils:"
FILESEXTRAPATHS:prepend:espressobin-v7 = "${THISDIR}/patches-v7/a3700-utils:"
